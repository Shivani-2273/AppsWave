...
import com.ncema.client.resource.v1_0.AttachmentResource;
...
public abstract class BaseAttachmentResourceTestCase {
	...
	protected void assertContains(Object attachment, List<Object> attachments) {
	...
	protected void assertEquals(Object attachment1, Object attachment2) {
		Assert.assertTrue(
	...
	protected void assertEquals(
		List<Object> attachments1, List<Object> attachments2) {

		Assert.assertEquals(attachments1.size(), attachments2.size());

		for (int i = 0; i < attachments1.size(); i++) {
			Object attachment1 = attachments1.get(i);
			Object attachment2 = attachments2.get(i);
	...
	protected void assertEqualsIgnoringOrder(
		...
		for (Object attachment1 : attachments1) {
			boolean contains = false;

			for (Object attachment2 : attachments2) {
	...
	protected void assertValid(Object attachment) throws Exception {
		boolean valid = true;
	...
	protected void assertValid(Page<Object> page) {
		...
		java.util.Collection<Object> attachments = page.getItems();
	...
	protected boolean equals(Object attachment1, Object attachment2) {
	...
	protected String getFilterString(
		EntityField entityField, String operator, Object attachment) {
	...
	@Inject
	private com.ncema.resource.v1_0.AttachmentResource _attachmentResource;
