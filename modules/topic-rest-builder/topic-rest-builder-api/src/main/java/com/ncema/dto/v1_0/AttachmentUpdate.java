...
@Schema(requiredProperties = {"fileName", "fileBase64", "mimeType"})
@XmlRootElement(name = "AttachmentUpdate")
public class AttachmentUpdate implements Serializable {

	public static AttachmentUpdate toDTO(String json) {
		return ObjectMapperUtil.readValue(AttachmentUpdate.class, json);
	}

	public static AttachmentUpdate unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(AttachmentUpdate.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.ncema.dto.v1_0.AttachmentUpdate",
		name = "x-class-name"
	)
