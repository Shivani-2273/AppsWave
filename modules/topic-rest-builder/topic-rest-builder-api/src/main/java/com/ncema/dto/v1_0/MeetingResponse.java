 ...
 */
@Generated("")
@GraphQLName(description = "Meeting response object", value = "MeetingResponse")
...
public class MeetingResponse implements Serializable {
	...
	public static MeetingResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(MeetingResponse.class, json);
	}

	public static MeetingResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(MeetingResponse.class, json);
	}
	...
	@Schema(description = "Array of full topic details")
	@Valid
	...
	@GraphQLField(description = "Array of full topic details")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public String toString() {
		...
		if (topics != null) {
			...
			for (int i = 0; i < topics.length; i++) {
				sb.append(String.valueOf(topics[i]));
	...
	@Schema(
		...
		defaultValue = "com.ncema.dto.v1_0.MeetingResponse",
		name = "x-class-name"
	)
