...
public interface AttachmentResource {
	...
	public HttpInvoker.HttpResponse deleteAttachmentHttpResponse(
			Long attachmentId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse updateAttachmentHttpResponse(
			Long attachmentId, AttachmentUpdate attachmentUpdate)
		throws Exception;
	...
	public static class AttachmentResourceImpl implements AttachmentResource {
		...
		public void deleteAttachment(Long attachmentId) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteAttachmentHttpResponse(attachmentId);
		...
		public HttpInvoker.HttpResponse deleteAttachmentHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/topic-rest-builder/v1.0/attachments/{attachmentId}");
		...
		public HttpInvoker.HttpResponse deleteAttachmentBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/topic-rest-builder/v1.0/attachments/batch");
		...
		public void updateAttachment(
			...
			HttpInvoker.HttpResponse httpResponse =
				updateAttachmentHttpResponse(attachmentId, attachmentUpdate);
		...
		public HttpInvoker.HttpResponse updateAttachmentHttpResponse(
			...
			httpInvoker.body(attachmentUpdate.toString(), "application/json");
